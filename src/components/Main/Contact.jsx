      ...
      <ThemeProvider theme={contactFont}>
        ...
        <Box>
          ...
          <Typography variant={`${width1000?"body1":"h5"}`} noWrap paragraph gutterBottom sx={{}}>
            <ContactMailIcon /> fuatsevinc@icloud.com{" "}
          </Typography>
          <Typography variant={`${width1000?"body1":"h5"}`} noWrap paragraph gutterBottom>
            <PhoneIcon /> +4915251348847{" "}
          </Typography>
          <Typography variant={`${width1000?"body1":"h5"}`} noWrap paragraph gutterBottom>
            <MyLocationOutlinedIcon /> Hamburg / GERMANY{" "}
          </Typography>
          </Box>
          <Container>
            <Button
              href={"https://www.linkedin.com/in/fuatsevinc/"}
              target="_blank"
              color="warning"
            >
            ...
            <Button
              href={"https://github.com/fuatsevinc"}
              target="_blank"
              color="warning"
            >
